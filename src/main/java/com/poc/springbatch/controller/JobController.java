...
public class JobController {
    ...
    public ResponseEntity productLoad(){
        try{
            ...
            return ResponseEntity.ok("job productJob terminé avec succès !");

        }catch (Exception e){
            return new ResponseEntity("job productJob en erreur : " + e.getLocalizedMessage(), HttpStatus.EXPECTATION_FAILED);
        }
