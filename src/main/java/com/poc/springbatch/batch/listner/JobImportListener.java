...
import com.poc.springbatch.batch.JobConstants;
...
@Component
public class JobImportListener implements JobExecutionListener {
    ...
    private final FileReaderListner fileReadListener;
    ...
    private void log(StepExecution stepExecution) {
        ...
        if (stepExecution.getStepName().contains("tondeuseStep")) {
            ...
            skippableOffset.addAll(fileSkipListener.getSkippableOffset());
            skippableOffset.addAll(fileReadListener.getErrorReadOffset());
